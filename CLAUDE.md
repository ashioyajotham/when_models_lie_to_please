...
|-------|---------------------|-----|
| ICLR 2027 | Sep 2026 | Main venue for mechanistic interpretability |
| NeurIPS 2026 (SafeGenAI workshop) | Jun 2026 | Safety-focused, workshop paper possible |
| ICML 2027 | Jan 2027 | Technical depth |
| Alignment Forum / LessWrong | Anytime | Pre-publication community feedback |
| Deep Learning Indaba 2026 | Varies | Connect to African AI research community |
